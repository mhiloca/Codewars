...
def find_even_index(arr):
    for index in range(len(arr)):
        if index == 0:
            if sum(arr[x+1] for x in range(len(arr) - 1)) == 0:
                return 0
        elif index == -1:
            if sum(arr[x] for x in range(len(arr) - 1)) == 0:
                return len(arr) - 1
        else:
            if sum(x for x in arr[:index]) == sum(y for y in arr[index+1:]):
                return index
    return -1


def find_even_index_v2(arr):
...
print(find_even_index_v2([1,2,3,4,3,2,1]))
print(find_even_index_v2([1,100,50,-51,1,1]))
print((find_even_index_v2([1,2,3,4,5,6])))
print((find_even_index_v2([20,10,30,10,10,15,35])))
print((find_even_index_v2([20,10,-80,10,10,15,35])))
print((find_even_index_v2([10,-80,10,10,15,35,20])))
print((find_even_index_v2(range(1,100))))
print((find_even_index_v2([0,0,0,0,0])))
print((find_even_index_v2([-1,-2,-3,-4,-3,-2,-1])))
print((find_even_index_v2(range(-100,-1))))